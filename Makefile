...
help:
	...
	@printf "\n"
	@printf "  \033[32m◇\033[0m  make version-show  \033[2mShow current version, tag, and tag-state\033[0m\n"
	@printf "  \033[32m◇\033[0m  make version-bump VERSION=X \033[2mBump version (patch|minor|major|x.y.z)\033[0m\n"
	@printf "\n"
