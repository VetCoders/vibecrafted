(function () {
  ...
  var frameworkLocale = /^pl\b/i.test(document.documentElement.lang || "")
    ? "pl"
    : "en";
  var FRAMEWORK_I18N = {
    en: {
      ...
      showcaseLead:
        "Board-first teaching surface. Trace the frame, tune the grooves, invite specialists, then let Marbles run the convergence batches.",
      ...
      hints: {
        workflow:
          "Tune groove density until the board exposes the right amount of working capacity.",
        init: "Bootstrap context so the first true grooves are cut from history instead of guessed from nothing.",
        research:
          "Probe the lane choices before committing force. Research narrows the search space and marks the promising paths.",
        marbles:
          "Set the marbles count and force, then let the board run the convergence sequence by itself.",
        agents: "Select specialist count and spawn them into the grooves.",
        scaffold:
          "Choose the outer frame first. Capacity comes later, once the board shape is real.",
        review:
          "Run a stress pass on the first placements before the noisy convergence loops begin.",
        followup:
          "Shake the board and see which claims of progress were never truly anchored.",
        prune:
          "Remove weak or unnecessary fits so the board can converge around the stronger core.",
        dou: "Flash the undone truth in red and expose what still blocks shipping.",
        hydrate:
          "Fill the remaining critical gaps with deterministic precision.",
        decorate:
          "Apply final polish pass to saturate colors and sharpen the finish.",
        release:
          "Launch the finished surface and release the loop to the market.",
      },
      phaseOverrides: {},
    },
    pl: {
      ...
      showcaseLead:
        "Plansza jako powierzchnia nauki. Wyznacz ramę, dostrój rowki, zaproś specjalistów, a potem pozwól Marbles uruchomić batchowe domykanie.",
      ...
      hints: {
        workflow:
          "Dostrój gęstość rowków, aż plansza pokaże właściwą pojemność roboczą.",
        init: "Zainicjuj kontekst, żeby pierwsze prawdziwe rowki były wycinane z historii zamiast zgadywane od zera.",
        research:
          "Przetestuj możliwe tory, zanim dołożysz siłę. Research zawęża przestrzeń szukania i zaznacza obiecujące ścieżki.",
        marbles:
          "Ustaw liczbę kulek i siłę, a potem pozwól planszy samodzielnie uruchomić sekwencję konwergencji.",
        agents: "Wybierz liczbę specjalistów i wpuść ich w rowki.",
        scaffold:
          "Najpierw wybierz zewnętrzną ramę. Pojemność przychodzi później, gdy kształt planszy jest już prawdziwy.",
        review:
          "Uruchom pass stresowy dla pierwszych ułożeń, zanim zaczną się głośniejsze pętle domykania.",
        followup:
          "Potrząśnij planszą i sprawdź, które deklaracje postępu nigdy nie były naprawdę osadzone.",
        prune:
          "Usuń słabe albo zbędne dopasowania, żeby plansza mogła domknąć się wokół mocniejszego rdzenia.",
        dou: "Pokaż na czerwono prawdę o niedomknięciu i ujawnij, co nadal blokuje release.",
        hydrate:
          "Wypełnij pozostałe krytyczne luki z deterministyczną precyzją.",
        decorate:
          "Nałóż końcowy polish pass, żeby nasycić kolory i wyostrzyć finish.",
      ...
      phaseOverrides: {
        scaffold: {
          ...
          description:
            "Najpierw wyznacz granicę. Scaffold dotyczy tylko sylwetki planszy, zanim zdecydujemy, ile rowków ma unieść.",
        ...
        init: {
          ...
          description:
            "Init zakotwicza planszę w rzeczywistości. Historia i struktura zaczynają wycinać prawdziwe rowki, żeby późniejsza praca miała gdzie lądować.",
        ...
        research: {
          ...
          description:
            "Research bada przestrzeń opcji, zanim wejdziemy w throughput. Plansza zaczyna podświetlać, które rowki mają znaczenie, które są zmyłką i gdzie dołożyć kolejne ciśnienie.",
        ...
        workflow: {
          ...
          description:
            "Tutaj definiujemy pojemność. Workflow decyduje, ile rowków plansza wystawi, żeby dalsza praca wpadała w prawdziwy model operacyjny zamiast pustej tekstury.",
        ...
        agents: {
          ...
          description:
            "Kilka celowych kulek ląduje czysto. Wczesna praca agentów ma być precyzyjna, a nie jak chaos rozpylony po planszy.",
        ...
        marbles: {
          ...
          description:
            "Docierają kolejne batch’e i rośnie entropia. To uczciwy środek: throughput przyspiesza, ale rośnie też szum.",
        ...
        review: {
          ...
          description:
            "Review sprawdza, czy ułożony wzór naprawdę odpowiada intencji. Słabe dopasowania, spillover i podejrzane ułożenia stają się widoczne pod presją.",
        ...
        followup: {
          ...
          description:
            "Luźne kulki zaczynają odpadać. Followup to moment, w którym głośne deklaracje sukcesu zderzają się z tym, co naprawdę się trzyma.",
        ...
        prune: {
          ...
          description:
            "Część pozornie solidnych elementów jest usuwana celowo. Prune otwiera luki na nowo, żeby plansza mogła domknąć się wokół mocniejszego kształtu.",
        ...
        dou: {
          ...
          description:
            "Wyciągnij na czerwono prawdę. Uruchom systematyczną analizę luk na całej powierzchni produktu, żeby zobaczyć, co nadal blokuje wysyłkę.",
        ...
        decorate: {
          ...
          description:
            "Osadzone kulki zyskują nasycenie i ostrość. Decorate nie jest przypadkową ornamentyką; to końcowy pass spójności, który sprawia, że system czuje się intencjonalny.",
        ...
        hydrate: {
          ...
          description:
            "Tutaj ruch zmienia ton. Pozostałe luki są domykane deterministycznie, po jednym krytycznym dla launchu otworze naraz.",
        ...
        release: {
          ...
          description:
            "Plansza rozświetla się, utrzymuje wzór, a potem blednie przed kolejnym cyklem. Shipping nie jest brakiem ruchu; to domknięta pętla gotowa, by zacząć od nowa.",
  ...
  var PHASES = [
    {
      ...
      description:
        "Set the boundary first. Scaffold is only about the silhouette of the board before we decide how many grooves it can carry.",
    ...
    },
    {
      ...
      description:
        "Init anchors the board in reality. History and structure start cutting true grooves into the frame so later work has somewhere real to land.",
    ...
    },
    {
      ...
      description:
        "Research explores the option space before we commit to throughput. The board starts highlighting which grooves matter, which are decoys, and where the next pressure should go.",
    ...
    },
    {
      ...
      description:
        "Now define capacity. Workflow decides how many grooves the board exposes, so later work lands into a real operating model instead of empty texture.",
    ...
    },
    {
      ...
      description:
        "A few deliberate marbles land cleanly. Early agent work should feel precise, not like chaos sprayed across the board.",
    ...
    },
    {
      ...
      description:
        "More batches arrive and entropy climbs. This is the honest middle: throughput increases, but so does noise.",
    ...
    },
    {
      ...
      description:
        "Review checks whether the landed pattern really matches the intent. Weak fits, spillover, and suspicious placements become visible under pressure.",
    ...
    },
    {
      ...
      description:
        "Loose marbles start falling away. Followup is where noisy success claims get tested against what actually holds.",
    ...
    },
    {
      ...
      description:
        "A few seemingly solid pieces are removed on purpose. Pruning reopens gaps so the board can converge around the stronger shape.",
    ...
    },
    {
      ...
      title: "Definition of Undone",
      description:
        "Surface the red truth. Run a systematic gap analysis across the entire product surface to expose what still blocks shipping.",
    ...
    },
    {
      ...
      description:
        "The settled marbles saturate and sharpen. Decorate is not random ornament; it is the final coherence pass that makes the system feel intentional.",
    ...
    },
    {
      ...
      description:
        "Now the motion changes tone. The remaining gaps are handled deterministically, one launch-critical hole at a time.",
    ...
    },
    {
      ...
      description:
        "The board glows, holds, and then fades for the next cycle. Shipping is not the absence of motion; it is a completed loop ready to start again.",
  ...
  PHASES = PHASES.map(function (phaseDef) {
    return Object.assign(
      {},
      phaseDef,
      FRAMEWORK_TEXT.phaseOverrides[phaseDef.name] || {},
    );
  });
  ...
  function lighten(c, n) {
    return {
      r: Math.min(255, c.r + n),
      g: Math.min(255, c.g + n),
      b: Math.min(255, c.b + n),
    };
  }
  ...
  function phaseCommand(phaseDef) {
    ...
    if (
      phaseDef.name === "scaffold" ||
      phaseDef.name === "research" ||
      phaseDef.name === "workflow" ||
      phaseDef.name === "dou"
    ) {
  ...
  function buildShowcaseMarkup(layout) {
    var metaSection =
      layout === "standalone"
        ...
        : [
            ...
            '      <p class="framework-playground__kicker">' +
              FRAMEWORK_TEXT.showcaseKicker +
              "</p>",
            '      <h3 class="framework-playground__heading">' +
              FRAMEWORK_TEXT.showcaseHeading +
              "</h3>",
            '      <p class="framework-playground__lede">' +
              FRAMEWORK_TEXT.showcaseLead +
              "</p>",
            "    </div>",
            "  </div>",
          ].join("");
    return [
      ...
      '      <span class="framework-playground__press-kicker" data-framework-phase-eyebrow>' +
        FRAMEWORK_TEXT.defaultEyebrow +
        "</span>",
      '      <span class="framework-playground__press-copy" data-framework-phase-press>' +
        FRAMEWORK_TEXT.defaultPressCopy +
        "</span>",
      "    </p>",
      ...
      "          <span>" +
        FRAMEWORK_TEXT.overlayPhase +
        " <strong data-framework-phase-label>Scaffold</strong></span>",
      "          <span>" +
        FRAMEWORK_TEXT.overlayConverge +
        " <strong data-framework-coverage>0%</strong></span>",
      "          <span>" +
        FRAMEWORK_TEXT.overlayMarbles +
        " <strong data-framework-marbles>0</strong></span>",
      "        </div>",
      ...
      '      <p class="framework-playground__side-kicker">' +
        FRAMEWORK_TEXT.operators +
        "</p>",
      ...
      '      <p class="framework-playground__side-kicker" style="margin-top: 0.35rem;">' +
        FRAMEWORK_TEXT.choosePhase +
        "</p>",
  ...
  function initFrameworkPlayground(root, rootIndex) {
    ...
    var startPhaseName =
      root.getAttribute("data-framework-start") || "scaffold";
    root.classList.add("framework-playground");
    root.classList.toggle(
      "framework-playground--standalone",
      layout === "standalone",
    );
    ...
    function currentPhaseCommand() {
      ...
      if (phaseDef.name === "scaffold") {
        return (
          'vibecrafted scaffold claude --prompt "Shape the board as ' +
          SHAPES[boardShape] +
          '"'
        );
      }
      if (phaseDef.name === "workflow") {
        return (
          'vibecrafted workflow claude --prompt "Tune groove density to ' +
          boardDensity.toFixed(1) +
          '"'
        );
      }
      if (phaseDef.name === "agents") {
        return (
          'vibecrafted partner claude --prompt "Spawn ' +
          agentBatchSize +
          ' specialist tracks"'
        );
      }
      if (phaseDef.name === "marbles") {
        return (
          "vibecrafted marbles codex --count " + marbleRunCount + " --depth 3"
        );
      }
    ...
    function resolvePhaseIndex(name) {
      for (var i = 0; i < PHASES.length; i++) {
        if (
          PHASES[i].name === name ||
          PHASES[i].label.toLowerCase() === String(name).toLowerCase()
        ) {
          return i;
        }
      }
    ...
    function buildSlots() {
      ...
      for (
        var y = centerY - boardRadius * 1.1;
        y <= centerY + boardRadius * 1.1;
        y += rh
      ) {
        var off = row % 2 ? sp / 2 : 0;
        for (
          var x = centerX - boardRadius * 1.1;
          x <= centerX + boardRadius * 1.1;
          x += sp
        ) {
          var px = x + off;
          var dx = px - centerX;
          ...
          if (shape === "circle") {
            isInside =
              Math.sqrt(dx * dx + dy * dy) + marbleRadius * 0.85 <= boardRadius;
          } else if (shape === "square") {
            isInside =
              Math.abs(dx) <= boardRadius * 0.85 &&
              Math.abs(dy) <= boardRadius * 0.85;
          } else if (shape === "hexagon") {
            var q = ((2 / 3) * dx) / (boardRadius * 0.8);
            var r =
              ((-1 / 3) * dx + (Math.sqrt(3) / 3) * dy) / (boardRadius * 0.8);
            var s = -q - r;
            ...
            isInside =
              Math.abs(dist - (spiralDist % boardRadius)) < sp * 0.5 &&
              dist < boardRadius;
          } else if (shape === "waves") {
            var wave = Math.sin(px * 0.05) * (boardRadius * 0.2);
            isInside =
              Math.abs(dy - wave) < sp * 0.8 &&
              Math.abs(dx) < boardRadius * 0.9;
          } else if (shape === "grid") {
    ...
    function drawBoardFrame(alpha, frameOnly) {
      ...
      if (!frameOnly) {
        ctx.beginPath();
        traceBoardShape(1);
        var interior = ctx.createRadialGradient(
          centerX,
          centerY,
          boardRadius * 0.18,
          centerX,
      ...
      ctx.beginPath();
      traceBoardShape(1);
      ctx.strokeStyle = frameOnly
        ? "rgba(242, 239, 221," + 0.18 * alpha + ")"
        : "rgba(242, 239, 221," + 0.1 * alpha + ")";
      ctx.lineWidth = frameOnly
        ? Math.max(1.2, marbleRadius * 0.08)
        : Math.max(1.4, marbleRadius * 0.12);
      ctx.stroke();
      ctx.restore();
    }
    ...
    function updateCoverage() {
      ...
      coveragePct =
        total > 0 ? Math.round(((filled + overflow) / total) * 100) : 0;
    }
    ...
    function renderPhaseControls(phaseIdx) {
      ...
      if (p.name === "scaffold") {
        ...
        densityRow.appendChild(
          createControlCaption("FRAME: " + SHAPES[boardShape].toUpperCase()),
        );
        var frameNote = document.createElement("div");
        frameNote.className = "framework-playground__side-copy";
        frameNote.textContent =
          "Lock the boundary first. Groove count belongs to Workflow.";
        ...
        agentBatchRow.appendChild(
          createControlCaption("SPECIALIST COUNT: " + agentBatchSize),
        );
        ...
        nextBtn.className =
          "framework-playground__action-btn framework-playground__action-btn--muted";
        ...
        batchRow.appendChild(
          createControlCaption("--COUNT: " + marbleRunCount),
        );
        ...
        powerRow.appendChild(
          createControlCaption("POWER: " + marblePower.toFixed(1)),
        );
        ...
        hydroBatchRow.appendChild(
          createControlCaption("PRECISION FILL: " + hydrateBatchSize),
        );
        ...
        polishRow.appendChild(
          createControlCaption(
            "POLISH INTENSITY: " + Math.round(polishIntensity * 100) + "%",
          ),
        );
        ...
        nextBtn.textContent =
          phaseIdx < PHASES.length - 1
            ? "PROCEED TO " + PHASES[phaseIdx + 1].label.toUpperCase()
            : "RESTART LOOP";
        nextBtn.onclick = function () {
    ...
    function updateUi(scrollToActive) {
      ...
      commandEl.classList.toggle(
        "is-live",
        phaseDef.name === "marbles" ||
          phaseDef.name === "agents" ||
          phaseDef.name === "hydrate",
      );
    ...
    function runReviewPass() {
      ...
      var reviewThrows = Math.min(
        Math.max(2, agentBatchSize),
        candidates.length,
      );
    ...
    function syncSlotVisibility() {
      ...
      for (var i = 0; i < slots.length; i++) {
        slots[i].visible =
          slots[i].revealOrder < visibleCount ||
          phase > resolvePhaseIndex("workflow");
      }
    }
    ...
    function updatePhase(dt, isSimulating) {
      ...
      switch (p.name) {
        ...
        case "init":
          ...
          grooveRevealProgress = Math.min(
            0.18,
            (phaseTime / p.duration) * 0.18,
          );
          break;
        case "research":
          boardAlpha = Math.max(boardAlpha, 1);
        ...
        case "agents":
          if (isSimulating && throwTimer <= 0) {
            ...
            if (precise.length > 0) {
              marbles.push(
                spawnMarble(
                  precise[Math.floor(Math.random() * precise.length)],
                  0.15,
                  "ocean",
                ),
              );
          ...
          if (isSimulating && throwTimer <= 0) {
            ...
            if (overflowSlots.length > 0) {
              marbles.push(
                spawnMarble(
                  overflowSlots[
                    Math.floor(Math.random() * overflowSlots.length)
                  ],
                  0.8,
                ),
              );
        ...
        case "decorate":
          marbles.forEach(function (m) {
            if (m.settled)
              m.saturation = Math.min(
                1,
                0.6 + polishIntensity * 0.4 + phaseTime * 0.0001,
              );
          });
          break;
        case "release":
    ...
    function render() {
      ...
      if (boardAlpha > 0) {
        ...
        if (coveragePct > 90) {
          ...
          if (shape === "circle")
            ...
            ctx.rect(
              centerX - boardRadius * 1.05,
              centerY - boardRadius * 1.05,
              boardRadius * 2.1,
              boardRadius * 2.1,
            );
          else if (shape === "hexagon") {
      ...
      if (errorFlash > 0) {
        ...
        if (errorFlash > 0.3) {
          ...
          ctx.font =
            "700 " +
            boardRadius * 0.24 +
            'px "IBM Plex Mono", "JetBrains Mono", monospace';
          ctx.fillStyle = "#e05544";
      ...
      for (var m = 0; m < allMarbles.length; m++) {
        ...
        ctx.drawImage(
          ...
          marble.y - hover - sprite.height / 2,
        );
      }
    ...
    function showPhase(target, hardReset) {
      ...
      if (hardReset) {
        for (var i = 0; i <= target; i++) {
          ...
          advanceSimulation(
            PHASES[i].duration *
              (i === target ? PHASES[i].snapshotRatio || 0.55 : 1),
          );
        }
      }
    ...
    function resize() {
      ...
      if (
        Math.abs(rect.width - measuredWidth) < 1 &&
        Math.abs(rect.height - measuredHeight) < 1
      )
        return;
      ...
      centerY = height / 2;
      boardRadius =
        Math.min(width, height) * (layout === "standalone" ? 0.43 : 0.38);
      marbleRadius = Math.max(
        6,
        boardRadius * (layout === "standalone" ? 0.056 : 0.065),
      );
      buildSlots();
    ...
    PHASES.forEach(function (phaseDef, index) {
      ...
      button.dataset.frameworkTooltip =
        phaseDef.title + " — " + phaseDef.description;
      button.setAttribute(
        "aria-label",
        phaseDef.label + ". " + phaseDef.title + ". " + phaseDef.description,
      );
  ...
  Array.prototype.forEach.call(
    document.querySelectorAll("[data-framework-playground]"),
    initFrameworkPlayground,
  );
})();
