...
**hello@vetcoders.io**. All complaints will be reviewed and investigated
promptly and fairly.

That address is the project's existing public contact (see
[SECURITY.md](SECURITY.md)). Use it for conduct reports. Security
vulnerabilities stay on the responsible-disclosure path in `SECURITY.md`
