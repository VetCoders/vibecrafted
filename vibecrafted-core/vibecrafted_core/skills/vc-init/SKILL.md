...
> **Invocation for `vc-init` (launcher `init`)**
>
...
> | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
> | 1. User-launched worker | `vibecrafted init [agent]` / `vc-init`                                                                                                |
> | 2. Interactive          | `/vc-init` — execute **in this session**; use native subagents when required; do **not** externalize merely because a launcher exists |
...
>
> **Note:** Orientation gate, not a write pipeline. Worker form is `vibecrafted init [agent]`.
