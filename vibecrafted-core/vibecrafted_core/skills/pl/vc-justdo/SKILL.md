...
>
> **Uwaga:** Alias of **implement** — same pipeline; prefer `implement` in new briefs.
...
jawnie o to prosi w tym prompcie. Czytaj pliki ponownie przed edycją; substrate-failure jeśli drzewo zatrute.
Zobacz [Reguła Living Tree](../LIVING_TREE_RULE.md).

## Checkpoint orientacji (no-question ≠ no-orientation)
